...
enum class HttpVersion : std::uint8_t { HTTP_1_0 = 0, HTTP_1_1, HTTP_2_0, UNKNOWN };
...
{
    if(version.Equals(SV_HTTP11))
        return HttpVersion::HTTP_1_1;
    if(version.Equals(SV_HTTP10))
        return HttpVersion::HTTP_1_0;
    if(version.Equals(SV_HTTP20))
