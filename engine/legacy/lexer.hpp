...
private:
    ...
    const std::unordered_map<std::string_view, TokenType> identifier_map = {
        {"Auto", TOKEN_KEYWORD_AUTO},   {"Void", TOKEN_KEYWORD_VOID},
        {"Int", TOKEN_KEYWORD_INT},     {"Float", TOKEN_KEYWORD_FLOAT},
        {"Cast", TOKEN_KEYWORD_CAST},   {"If", TOKEN_KEYWORD_IF},
        {"Elif", TOKEN_KEYWORD_ELIF},   {"Else", TOKEN_KEYWORD_ELSE},
        {"For", TOKEN_KEYWORD_FOR},     {"in", TOKEN_KEYWORD_IN},
        {"is", TOKEN_KEYWORD_IS},       {"While", TOKEN_KEYWORD_WHILE},
        {"Func", TOKEN_KEYWORD_FUNC},   {"Continue", TOKEN_KEYWORD_CONTINUE},
        {"Break", TOKEN_KEYWORD_BREAK}, {"Return", TOKEN_KEYWORD_RETURN},
    };
};
