...
inline const std::unordered_map<std::string_view, std::string_view> MIME_FROM_EXT = {
    ...
    {"gz", "application/gzip"},
    {"tgz", "application/gzip"}, // common tarball alias
    ...
    {"chm", "application/vnd.ms-htmlhelp"},     // Windows .chm help files
...
inline const std::unordered_map<std::string_view, std::string_view> PORT_FROM_PROTOCOL =
    {{"http", "80"},       {"https", "443"},  {"ws", "80"},       {"wss", "443"},    {"ftp", "21"},
     ...
     {"mqtts", "8883"},    {"redis", "6379"}, {"rediss", "6380"}, {"mysql", "3306"}, {"postgres", "5432"},
     {"mongodb", "27017"}, {"amqp", "5672"},  {"amqps", "5671"},  {"grpc", "50051"}, {"grpc+tls", "50052"},
     {"kafka", "9092"},    {"kafkas", "9093"}};
