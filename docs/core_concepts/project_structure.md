...
Contains all log output generated by the server. This directory is created automatically at startup if file logging is enabled in `wfx.toml`. It is not created by default.
